...
RUN pip3 install -U biopython==1.73 tabulate cgecore==1.4.2 argparse;
...
COPY choleraefinder.py /usr/src/choleraefinder.py

RUN chmod 755 /usr/src/choleraefinder.py; \
...
ENTRYPOINT ["/usr/src/choleraefinder.py"]
